 ...
 @endsection
 @section('title', 'Liste Departement')
 @section('content')
                     ...
                     <div class="col-12">
                         <div class="card">
                             <div class="card-header">
                                 <h2 class="card-title py-1"><b>Liste des départements</b></h2>
                                 <a href="{{ route('departements.create') }}" class="btn btn-success float-right"><i
                                     ...
                                     <tbody>
                                         @forelse ($departements as $departement)
                                             <tr>
                                                 ...
                                                 <td class="text-center">{{ $departement->email }}</td>
                                                 <td class="text-center"> {{ $departement->telephone }}</td>
