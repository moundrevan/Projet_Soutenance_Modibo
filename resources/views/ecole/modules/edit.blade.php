...
@section('title', 'Modification Module')
@section('content')
                                        ...
                                        <form action="{{ route('modules.update', $module) }}" method="post"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="code" id="code"
                                                            ...
                                                            value="{{ $module->code }}" required placeholder="Code">
                                                        @error('code')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nom" id="nom"
                                                            ...
                                                            value="{{ $module->nom }}" required placeholder="Nom">
                                                        @error('nom')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="description" id="description"
                                                            ...
                                                            value="{{ $module->description }}" required
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="coefficient" id="coefficient"
                                                            ...
                                                            value="{{ $module->coefficient }}" required
                                            ...
                                            <div class="col-12">
                                                <div class="form-group button">
                                                    ...
                                                    <a href="{{ route('modules.index', $module) }}" class="btn btn-danger">
