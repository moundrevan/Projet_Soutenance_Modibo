                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title py-1"><b>Liste des Classes</b></h2>
                                <a href="{{ route('classes.create') }}" class="btn btn-success float-right"><i
                                    ...
                                    <tbody>
                                        @forelse ($classes as $classe)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $classe->description }}</td>
